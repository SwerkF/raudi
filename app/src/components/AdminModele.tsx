...
function AdminModele() {
        ...
        const handleEdit = (modele: any) => {
            ...
            axios.put(`http://localhost:3000/api/modele/${currentModele.id}`, formData, {
                headers: {
        ...
        const handleDelete = (id: number) => {
            axios.delete(`http://localhost:3000/api/modele/${id}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            })
        ...
        const handleSubmit = async (e: any) => {
            ...
            axios.post("http://localhost:3000/api/modele", formData, {
              headers: {
                "Content-Type": "multipart/form-data", // Important for file upload
                Authorization: `Bearer ${localStorage.getItem("token")}`,
              },
                                ...
                                <tbody>
                                    {modeles && modeles.map((modele: any) => (
                                        <tr key={modele.id}>
                                            ...
                                            <td>{modele.prix}</td>
                                            <td>
                                                <button onClick={() => setCurrentModele(modele)} className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</button>
                                                <button onClick={() => handleDelete(modele.id)} className="btn btn-danger">Delete</button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
                        ...
                        <form onSubmit={handleSubmit} className="row mt-3">
                            <div className="col-6 mb-3">
                                ...
                                <input 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, nom: e.target.value})} 
                                />
                            </div>
                            <div className="col-6 mb-3">
                                ...
                                <input 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, prix: e.target.value})} 
                                />
                            </div>
                            <div className="col-12 mb-3">
                                ...
                                <textarea 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, description: e.target.value})} 
                                />
                            </div>
                            <div className="col-6 mb-3">
                                ...
                                <input 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, nombre_portes: e.target.value})} 
                                />
                            </div>
                            <div className="col-6 mb-3">
                                ...
                                <input 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, nombre_places: e.target.value})} 
                                />
                            </div>
                            <div className="col-6 mb-3">
                                ...
                                <input 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, taille: e.target.value})} 
                                />
                            </div>
                            <div className="col-6 mb-3">
                                ...
                                <input 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, vitesse_max: e.target.value})} 
                                />
                            </div>
                            <div className="col-6 mb-3">
                                ...
                                <input 
                                    ...
                                    onChange={e => setSubmitModele({...submitModele, couleur: e.target.value})} 
                                />
                            </div>
                            <div className="col-6 mb-3">
                                <label className="form-label">Moteur: </label>
                                <select className="form-select" aria-label="Default select example" onChange={(e) => setSubmitModele({...submitModele, moteur_id: e.target.value})}>
                                    {moteurs && moteurs.map((moteur: any) => (
                                        <option key={moteur.id} value={moteur.id}>{moteur.type} - {moteur.puissance} CV</option>
                                    ))}
                                </select>
                            </div>
                            <div className="col-12 mb-3">
                                ...
                                <input 
                                    type="file" 
                                    className="form-control"
                                    onChange={e => setSubmitModele({...submitModele, image: e.target.files})} 
                                />
                            </div>
                            <button type="submit" className="btn btn-success">Ajouter Modele</button>
                        </form>
                    </div>
                    <div className="modal fade" id="exampleModal"  aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div className="modal-dialog">
                            ...
                            <div className="modal-body">
                                {
                                    currentModele ? (
                                        ...
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, nom: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Prix du modele: </label>
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, prix: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Description du modele: </label>
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, description: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Nombre de portes: </label>
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, nombre_portes: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Nombre de places: </label>
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, nombre_places: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Taille: </label>
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, taille: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Vitesse max: </label>
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, vitesse_max: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Couleur: </label>
                                        <input 
                                            ...
                                            onChange={e => setCurrentModele({...currentModele, couleur: e.target.value})} 
                                        />
                                    </div>
                                    <div className="col-6 mb-3">
                                        <label className="form-label">Moteur: </label>
                                        <select className="form-select" aria-label="Default select example" onChange={(e) => setCurrentModele({...currentModele, moteur_id: e.target.value})}>
                                            {moteurs && moteurs.map((moteur: any) => (
                                                <option key={moteur.id} value={moteur.id}>{moteur.type} - {moteur.puissance} CV</option>
                                            ))}
                                        </select>
                                    ...
                                    <div className="col-6 mb-3">
                                        ...
                                        <input 
                                            type="file" 
                                            className="form-control"
                                            onChange={e => setCurrentModele({...currentModele, image: e.target.files})} 
                                        />
                                    </div>
                                            </div>
                            ...
                            <div className="modal-footer">
                                ...
                                <button onClick={() => handleEdit(currentModele)} type="button" className="btn btn-primary">Save changes</button>
                            </div>
                            </div>
                        </div>
                    </div>
