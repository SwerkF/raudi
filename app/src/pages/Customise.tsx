              ...
              <div className="col-9">
                ...
                <div className="d-flex justif-content-start">
                  <div className="image" style={{ paddingRight: "30px" }}>
                    <img
                      src={"http://localhost:3000/src/" + modele.image}
                      width={"100px"}
                      alt={modele.image}
                    />
                  </div>
                  <div className="d-flex flex-column justify-content-center">
                    ...
                    <p className="mb-0">
                      {modele.prix} € - {modele.vitesse_max} km/h -{" "}
                      <span
                        style={{
                          width: "20px",
                          height: "20px",
                          borderRadius: "50%",
                          backgroundColor: handleGetColor(modele.couleur),
                  ...
                  {options &&
                    options.map((option: any) => {
                      return (
                        ...
                        <div
                          key={option.id}
                          className="col-3 d-flex flex-row align-items-center"
                        >
                          <input
                            type="checkbox"
                            name={option.nom}
